...
// ===== margin
const marginTop = (number: number) =>
  css`
    margin-top: ${number * baseUnit}px;
  `;
const marginRight = (number: number) =>
  css`
    margin-right: ${number * baseUnit}px;
  `;
const marginBottom = (number: number) =>
  css`
    margin-bottom: ${number * baseUnit}px;
  `;
const marginLeft = (number: number) =>
  css`
    margin-left: ${number * baseUnit}px;
  `;

// ===== padding
const paddingTop = (number: number) =>
  css`
    padding-top: ${number * baseUnit}px;
  `;
const paddingRight = (number: number) =>
  css`
    padding-right: ${number * baseUnit}px;
  `;
const paddingBottom = (number: number) =>
  css`
    padding-bottom: ${number * baseUnit}px;
  `;
const paddingLeft = (number: number) =>
  css`
    padding-left: ${number * baseUnit}px;
  `;
...
`;
const borderColor = (color: TColorKeys) =>
  css`
...
// ===== background color
const backgroundColor = (color: TColorKeys) =>
  css`
    background-color: ${colors[color]};
  `;

// ===== color
const color = (color: TColorKeys) =>
  css`
    color: ${colors[color]};
  `;
...
// ===== display
const display = (display: displayType) =>
  css`
    display: ${display};
  `;

// ===== text align
const textAlign = (align: textAlignType) =>
  css`
    text-align: ${align};
  `;
...
// ===== flex wrap
const flexWrap = (wrap: flexWrapType) =>
  css`
    flex-wrap: ${wrap};
  `;
// ===== flex wrap
